...
const (
	UserService_Create_FullMethodName    = "/mock_v1.UserService/Create"
	UserService_GetByUUID_FullMethodName = "/mock_v1.UserService/GetByUUID"
)
...
func (c *userServiceClient) GetByUUID(ctx context.Context, in *GetByUUIDRequest, opts ...grpc.CallOption) (*GetByUUIDResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedUserServiceServer) GetByUUID(context.Context, *GetByUUIDRequest) (*GetByUUIDResponse, error) {
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "mock_v1.UserService",
